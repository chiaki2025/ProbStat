...
For the rest of this book, we mainly focus on \textbf{combinations}, and derive many probability density functions based on them. Like set theory, we don't go deeply into \textbf{counting techniques} since they are not the main concern of ProbStat.
...
\begin{figure}[h]
	...
	\label{Figure 5}
\end{figure}
\\Literally, probability is just a number that describes how likely an event can occur. I often relate it with "weight" quantity. As you can see in the sample space, I can assign arbitrarily the "weights" (or probabilites) of sample points as follow:
\begin{itemize}
