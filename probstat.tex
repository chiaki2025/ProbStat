...
\begin{corollary}
	...
	$$\sum_{y}g(x)=\sum_{x}h(y)=1$$
\end{corollary}
\textbf{Corollary 3.4.0.2} is directly derived from the \textbf{Definition 3.4.2}, and you can verify them by using the probability distribution table.
